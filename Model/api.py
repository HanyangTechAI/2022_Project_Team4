...
import cv2
from os import path
from .E2FGVI.video_inpainting import VideoInpaintingModel
from .E2FGVI.utils import save_video
import time
...
def Process(videoId):
    if(videoId in videoId_to_class):
        ...
        inpainted = VideoInpaintingModel().inference(videoId_to_video[videoId],out_masks)
        save_video(inpainted,videoId_to_fps[videoId],videoId)
